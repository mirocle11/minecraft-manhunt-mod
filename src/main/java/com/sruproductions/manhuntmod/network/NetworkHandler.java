package com.sruproductions.manhuntmod.network;
...
public class NetworkHandler {
    ...
    public static final SimpleChannel INSTANCE = NetworkRegistry.newSimpleChannel(
            new ResourceLocation(ManhuntMod.MOD_ID, "main"),
            () -> PROTOCOL_VERSION,
    ...
    public static void register() {
        int id = 0;
//        INSTANCE.registerMessage(id++, CastSpellPacket.class, CastSpellPacket::encode, CastSpellPacket::decode, CastSpellPacket::handle);
